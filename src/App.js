    ...
    <div style={{ ...S.screen, padding: '32px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <div style={{ width: '100%', marginTop: 32 }}>
        <div style={{ ...S.card(), border: '1px solid #00F5A030' }}>
          ...
          <a href={`https://buy.stripe.com/REMPLACER_BREVET?prefilled_email=${encodeURIComponent(user?.email || '')}`} target="_blank" rel="noreferrer" style={{ display: 'block', textAlign: 'center', background: '#00F5A0', color: '#080812', borderRadius: 10, padding: '12px', fontSize: 14, fontWeight: 700, textDecoration: 'none' }}>
